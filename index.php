...
<html>
<head>
<title>Clubs  Management System || Home Page</title>
...
<div class="slider">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          <h3><b>Student Club Management System</h3>      
           </b>           
          <div class="readmore">
...
{               ?>
		...
		<b><a href="view-public-notice.php?viewid=<?php echo htmlentities ($row->ID);?>" target="_blank" style="color:blue;"></b>
